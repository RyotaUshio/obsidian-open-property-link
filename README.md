# Open Links in Properties for Obsidian.md

Auto-open links contained in specified properties.
...
3. Open the following URL in your browser: `obsidian://brat?plugin=RyotaUshio/obsidian-open-property-link`.
